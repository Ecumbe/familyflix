...
function bootstrapShared() {
  ...
  window.deleteEpisodeRemote = deleteEpisodeRemote;
  ...
  window.getVideoBaseUrlRemote = getVideoBaseUrlRemote;
  window.setVideoBaseUrlRemote = setVideoBaseUrlRemote;
  window.ensureVideoBaseUrlLoaded = ensureVideoBaseUrlLoaded;

  window.getAdminSecret = getAdminSecret;
  window.setAdminSecret = setAdminSecret;
  window.getVideoBaseUrl = getVideoBaseUrl;
  window.setVideoBaseUrl = setVideoBaseUrl;
  window.isAbsoluteHttpUrl = isAbsoluteHttpUrl;
  ...
  window.canUserAccessContent = canUserAccessContent;
  window.getProgressRecord = getProgressRecord;
  window.getProgressPercent = getProgressPercent;
  window.getContentProgressState = getContentProgressState;
  window.getEpisodeProgressState = getEpisodeProgressState;
